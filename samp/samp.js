...
function Sort(page, sort, default_order, filter, filter_value) {
  ...
  httpRequest.open("GET", "/websites/samp/samp_ajax_"+page+".php?sort="+sort+"&order="+order+"&filter="+filter+"&filter_value="+filter_value, true);
...
function Filter(page, filter, filter_value, sort, order) {
  ...
  httpRequest.open("GET", "/websites/samp/samp_ajax_"+page+".php?filter="+filter+"&filter_value="+filter_value+"&sort="+sort+"&order="+order, true);
  httpRequest.onreadystatechange = function() {
